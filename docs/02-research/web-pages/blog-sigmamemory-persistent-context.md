# Blog: SigmaMemory: Persistent Context for AI Pair Programmers
URL: https://www.sigmamind.ai/blog/sigmamemory-persistent-context
Fetched: 2026-05-09

## Headings (verbatim)
- H1: SigmaMemory: Persistent Context for AI Pair Programmers
- H2: Why your AI keeps forgetting
- H2: What SigmaMemory actually is
...
- H2: How to start using SigmaMemory
- H2: Final takeaway
- H2: Related Articles

## The 12 SigmaMemory MCP tools (verbatim, three groups)
...
- Token storage: `~/.sigmaspace/runtime.session` mode 0600.

## How memories surface
- Force-directed graph visualization (canvas-based) in SigmaSpace; drag, zoom, search with pulse highlight, shift-hover for ego mode.
...
## Pricing / plan info
- Mentions Pro tier includes SigmaMemory.
