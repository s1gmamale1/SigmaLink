  ...
  return (
    <div className="flex h-full min-h-0 flex-1 flex-col gap-4 p-6">
      ...
      <Tabs defaultValue="installed" className="flex min-h-0 flex-1 flex-col">
        ...
        <TabsContent value="installed" className="mt-3 flex min-h-0 flex-1 flex-col gap-4">
          <DropZone
            busy={installBusy}
          ...
          {updatePrompt ? (
            <div className="flex items-center justify-between rounded-md border border-amber-500/40 bg-amber-500/10 p-3 text-sm text-amber-200">
              <span>
                A skill named <span className="font-mono">{updatePrompt.name}</span> is already installed
                with different content. Update it?
              </span>
        ...
        <TabsContent value="marketplace" className="mt-3 min-h-0 flex-1 overflow-y-auto pb-6">
          <MarketplaceTab />
        </TabsContent>
      </Tabs>
