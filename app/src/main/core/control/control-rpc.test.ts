...
describe('control-rpc', () => {
  it('enable/disable toggle the flag and start/stop the host', async () => {
    ...
    const ctl = buildControlController({ kv: fakeKv(), credentials: fakeCreds('tok'), socketPath: '/tmp/c.sock', serverEntry: '/app/x.cjs', start, stop, liveConnections: () => 0, setBearer: () => {}, respondEscalation: () => {}, reportViewport: () => {} });
  ...
  it('freeze/unfreeze toggle the kill-switch', async () => {
    const ctl = buildControlController({ kv: fakeKv(), credentials: fakeCreds('tok'), socketPath: '/tmp/c.sock', serverEntry: '/app/x.cjs', start: async () => {}, stop: () => {}, liveConnections: () => 0, setBearer: () => {}, respondEscalation: () => {}, reportViewport: () => {} });
  ...
  it('connectCommand includes socket + token + server entry', async () => {
    const ctl = buildControlController({ kv: fakeKv(), credentials: fakeCreds('secret-tok'), socketPath: '/tmp/c.sock', serverEntry: '/app/x.cjs', start: async () => {}, stop: () => {}, liveConnections: () => 2, setBearer: () => {}, respondEscalation: () => {}, reportViewport: () => {} });
  ...
  it('rotateToken rotates + pushes the new token via setBearer', async () => {
    ...
    const ctl = buildControlController({ kv: fakeKv(), credentials: creds, socketPath: '/s', serverEntry: '/e', start: async () => {}, stop: () => {}, liveConnections: () => 0, setBearer, respondEscalation: () => {}, reportViewport: () => {} });
  ...
  it('respondEscalation forwards to the escalator', async () => {
    ...
    const ctl = buildControlController({ kv: fakeKv(), credentials: fakeCreds('t'), socketPath: '/s', serverEntry: '/e', start: async () => {}, stop: () => {}, liveConnections: () => 0, setBearer: () => {}, respondEscalation, reportViewport: () => {} });
