...
// include the new propose_amendment TOOL_BLURB line, and again at P3 Task 4
// to include the submit_task/check_task/get_report external mission plane
// lines (TOOL_BLURB itself is NOT part of the "legacy contract" this test
// protects — it's the shared, ever-growing tool list every caller gets
// regardless of charter/portfolio; only the charter/portfolio/amendments
// SUBSTITUTION mechanism is pinned).
