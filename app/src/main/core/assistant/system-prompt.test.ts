...
// workspaceRoot: '/tmp/ws' })` on the pre-Task-5 tip (git rev 7ecf50b — P2
// Task 4, the base this task branches from), via a throwaway tsx script
// dumping JSON.stringify(output). If this ever needs to change, regenerate
// it from that same pre-Task-5 revision, never from a post-refactor HEAD —
// see docs/superpowers/plans/2026-07-10-jorvis-p2-persistent-identity.md Task 5.
