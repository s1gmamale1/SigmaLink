...
**✅ C-058 / C-059 / C-060 RESOLVED** on branch `fix/shared-shell-quoter` (PR pending,
not yet merged). `app/src/shared/shell-quote.ts` is now the one quoter —
