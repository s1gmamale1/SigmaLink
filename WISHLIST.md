...
- ~~**[windows/UX] open workspaces as separate OS windows — full SPA per window + main-side ownership registry**~~ → **promoted to ROADMAP Phase 16 + ADR-009** (2026-06-12) → ✅ **SHIPPED v2.5.0** (#169 `2344093`). Permanent record: CHANGELOG `[2.5.0]` · plan `app/docs/superpowers/plans/2026-06-12-multi-window-workspaces.md` · ADR-009 · master memory. Follow-ups filed above under "[windows] multi-window follow-ups".
---
